...
export default function ServicesSection() {
  ...
  return (
    <section id="services" style={{ background: "#ffffff", paddingTop: "98px" }}>
      ...
      {/* ── Section header ── */}
      <div style={{ maxWidth: 1180, margin: "0 auto", padding: "clamp(64px,7vw,96px) clamp(24px,5vw,64px) clamp(24px,3vw,48px)" }}>
        <ScrollFadeUp>
          <h1 style={{ fontFamily: "var(--font-anton)", fontWeight: 400, fontSize: "clamp(44px,6.5vw,80px)", lineHeight: ".92", letterSpacing: "-1.5px", textTransform: "uppercase", margin: 0 }}>
            Services
          </h1>
      ...
      <div style={{ background: "#EAEAEA", borderTop: "1px solid #DCDBD7" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto", padding: "clamp(48px,5.5vw,96px) clamp(24px,5vw,64px)", display: "flex", flexWrap: "wrap", gap: "clamp(40px,5vw,72px)" }}>
          <div style={{ flex: "1 1 340px" }}>
            <ScrollFadeUp>
              <div style={{ fontFamily: "var(--font-anton)", fontSize: "clamp(48px,5.5vw,96px)", lineHeight: ".9", color: "#B6B5AD", letterSpacing: "-2px", marginBottom: 14 }}>01</div>
              <h2 style={{ fontFamily: "var(--font-anton)", fontWeight: 400, fontSize: "clamp(30px,3.6vw,46px)", lineHeight: 1.02, letterSpacing: "-.5px", textTransform: "uppercase", margin: 0 }}>
      ...
      <div style={{ background: "#FFFFFF", borderTop: "1px solid #DCDBD7" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto", padding: "clamp(48px,5.5vw,96px) clamp(24px,5vw,64px)", display: "flex", flexWrap: "wrap", gap: "clamp(40px,5vw,72px)" }}>
          <div style={{ flex: "1 1 340px" }}>
            <ScrollFadeUp>
              <div style={{ fontFamily: "var(--font-anton)", fontSize: "clamp(48px,5.5vw,96px)", lineHeight: ".9", color: "#D5D4CE", letterSpacing: "-2px", marginBottom: 14 }}>02</div>
              <h2 style={{ fontFamily: "var(--font-anton)", fontWeight: 400, fontSize: "clamp(30px,3.6vw,46px)", lineHeight: 1.02, letterSpacing: "-.5px", textTransform: "uppercase", margin: 0 }}>
      ...
      <div style={{ background: "#EAEAEA", borderTop: "1px solid #DCDBD7" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto", padding: "clamp(48px,5.5vw,96px) clamp(24px,5vw,64px)", display: "flex", flexWrap: "wrap", gap: "clamp(40px,5vw,72px)" }}>
          <div style={{ flex: "1 1 340px" }}>
            <ScrollFadeUp>
              <div style={{ fontFamily: "var(--font-anton)", fontSize: "clamp(48px,5.5vw,96px)", lineHeight: ".9", color: "#B6B5AD", letterSpacing: "-2px", marginBottom: 14 }}>03</div>
