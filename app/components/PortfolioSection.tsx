...
// ── Works data ────────────────────────────────────────────────────────────────
const WORKS = [
  { slot: "pf-escher",    index: "(01)", title: "Escher Sketch",     meta: "Olive Branch HS · 2025",                                badges: [{ src: "/boa-regional-2025.png", alt: "BOA Regional 2025" }, { src: "/mhsaa-state-2025.png", alt: "MHSAA State 2025" }], image: "/portfolio/images/pf-escher.jpeg",    audio: "/portfolio/audio/escher-sketch.mp3",    posY: 2  },
  { slot: "pf-spire",     index: "(02)", title: "Coming Soon",       meta: "Olive Branch HS · 2026",                                badges: [], image: "/portfolio/images/pf-spire.jpeg",     audio: "/portfolio/audio/eternal-spire.mp3",    locked: true, posY: 50 },
        ...
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: 24, marginTop: 28, minHeight: 96 }}>
          <div style={{ flex: "1 1 360px" }}>
            ...
            <CaptionAnimate initialDelay={650}>
              <div style={{ display: "flex", alignItems: "flex-end", gap: 14, height: "clamp(28px,4vw,56px)" }}>
                ...
                {work.badges.length > 0 && (
                  <div style={{ display: "flex", alignItems: "flex-end", flexShrink: 0 }}>
                    {work.badges.map((b, i) => (
                      // eslint-disable-next-line @next/next/no-img-element
                      <img key={b.src} src={b.src} alt={b.alt} style={{ height: isMobile ? (i > 0 ? 40 : 48) : (i > 0 ? 66 : 90), width: "auto", display: "block", marginLeft: i > 0 ? (isMobile ? 10 : 22) : 0 }} />
                    ))}
                  </div>
                )}
              </div>
